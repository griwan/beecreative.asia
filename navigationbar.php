        ...
        <ul class="nav navbar-nav navbar-right" style="font-size: 100%;">
          ...
          <li role="presentation" class="dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a href="ourboard.php"><b>OUR BOARD</b></a></li>
            </ul>
          </li>
          <li>
            <a  href="cluster.php"><b>CLUSTERS</b></a>
          </li>
          <li>
            <a href="bcinschool.php"><b>WHY BEECREATIVE?</b></a>
          </li>
          <li>
            <a  href="faq.php"><b>LEARN MORE</b></a>
          </li>
          <li>
            <a  href="brochure/brochure.pdf" target="_blank"><b>BROCHURE</b></a>
          </li>
        </ul>
      </div>
    </div>
